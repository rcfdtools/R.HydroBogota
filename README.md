...
* Incorporación de levantamiento Lidar (0.5m) de la zona de descarga del Río Bogotá entre la descarga del Río Tunjuelo y el Salto del Tequendama. El modelo de terreno ensamblado no dispone de información detallada de este corredor, lo que ocasiona que el flujo de la llanura no pueda ser descargado completamente luego de la descarga súbita modelada desde los embalses.
