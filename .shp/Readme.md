...
### Grupos hidrológicos y tasas de infiltración (mm/hr)
...
| Localización | ReadyDEM=0 | ReadyDEM=1 | Σ ReadyDEM | ReadyRAS |
|:-------------|:----------:|:----------:|:----------:|:--------:|
